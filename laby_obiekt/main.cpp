...
public:
	...
	void Run() {
		...
		InitAudioDevice();
		Sound shootSound = LoadSound("machine-gun-01.wav");
		Sound deathSound = LoadSound("funny-sound-effect-for-quotjack-in-the-boxquot-sound-ver2-110924.wav");
		...
		while (!WindowShouldClose()) {
			...
			if (!player->IsAlive() && !deathSoundPlayed) {
